...
rootRef.on("child_added", snap => {
	...
	$('#posts').append("<dl><dt id='"+ lof+ "'>" + lof + "<dt><dt>Location</dt><dd>"+ location+"</dd><dt>Date</dt><dd>"+date+"</dd><img src='img/send_icon.svg' alt='Sendyour email' height='42' width='42'></dl>");
});